...
export const submitSecurityFeedback = <ThrowOnError extends boolean = false>(options: Options<SubmitSecurityFeedbackData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
